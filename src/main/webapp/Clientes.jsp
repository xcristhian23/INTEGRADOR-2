...
<html>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <ul class="dropdown-menu text-left" aria-labelledby="dropdownMenuButton">
                        ...
                        <li> <a class="dropdown-item" href="ControladorUsuario?menu=Perfil&accion=Desactivar&id=${correo.getIdUsuario()}" onclick="return confirmarDesactivar()">Desactivar cuenta</a></li>
                    </ul>
                    </div>
                    <li class="nav-item">
                        <a style="margin-left: 10px; border: none" class="btn btn-outline-light" href="ControladorUsuario?menu=Bici&accion=listar&id=${correo.getIdUsuario()}" target="myFrame">Bicicletas</a>
                    </li>
                    <li class="nav-item">
                        <a style="margin-left: 10px; border: none" class="btn btn-outline-light" href="ControladorUsuario?menu=CitasCl&accion=listarC&id=${correo.getIdUsuario()}" target="myFrame">Citas</a>
                    </li>
    ...
    <script>
        ...
        function confirmarDesactivar() {
            ...
            var confirmacion = confirm('¿Deseas desactivar su cuenta?');
